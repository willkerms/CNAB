 ...
 * @since 2019-07-30
 */
class CNABSicoobNetEmpresarialRET400 extends CNABSicoobNetEmpresarial {
	...
	private function addReg($reg, $row){
		...
		//O n̼mero no final identifica a sequencia do campo de acordo com o documento: Layot Arquivo Retorno CNAB400 2012-06-04.pdf
