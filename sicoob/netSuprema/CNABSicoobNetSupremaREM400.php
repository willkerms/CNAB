...
class CNABSicoobNetSupremaREM400 extends CNABSicoobNetSuprema {
	...
	public function getFile($msgRespBeneficiario1 = "", $msgRespBeneficiario2 = "", $msgRespBeneficiario3 = "", $msgRespBeneficiario4 = "", $msgRespBeneficiario5 = ""){
		...
		$this->addField("9", 1);//1
		$this->addField("", 193);//2
		$this->addField($msgRespBeneficiario1, 40);//3
		$this->addField($msgRespBeneficiario2, 40);//4
		$this->addField($msgRespBeneficiario3, 40);//5
		$this->addField($msgRespBeneficiario4, 40);//6
		$this->addField($msgRespBeneficiario5, 40);//7
		$this->addField($this->sequencial++, 6, "0");//8
		$this->addField("\r\n", 2);
