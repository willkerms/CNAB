...
class CNABSantanderREM240 extends CNABSantander {
	...
	public function __construct	($tpBeneficiario, $cpfCnpjBeneficiario, $agencia, $verificadorAgencia, $conta, $verificadorConta, $carteira, $codCliente, $beneficiario, $codRemessa, $gravacaoRemessa = "", $horaRemessa = ""){
		...
		//docs/santander/CNAB240.xls
		//Header do Arquivo
		$this->addField("33", 3, '0', STR_PAD_LEFT, 'banco');
		...
		$this->addField("", 6, ' ', STR_PAD_RIGHT);//Reservado uso Banco
		$this->addField($codRemessa, 6, '0', STR_PAD_LEFT, 'numSequencialArquivo');
		$this->addField('40', 3, '0', STR_PAD_LEFT, 'versaoLayout');
		$this->addField("", 74, ' ', STR_PAD_RIGHT);//Reservado uso Banco
		$this->addField("\r\n", 2, '', STR_PAD_LEFT);
		...
		//Header Lote
		$this->addField("033", 3, '0', STR_PAD_LEFT, 'banco');
		...
		$this->addField("30", 3, '0', STR_PAD_LEFT, 'layoutLote');
		$this->addField("", 1, ' ', STR_PAD_LEFT);//Uso exclusivo FEBRABAN
		$this->addField($this->getTpPessoa(), 1, ' ', STR_PAD_LEFT, 'tipoInscricao');
		$this->addField($this->getCpfCnpj(), 15, '0', STR_PAD_LEFT, 'cpfCnpj');
		$this->addField("", 20, ' ', STR_PAD_LEFT);//Uso exclusivo FEBRABAN
		$this->addField($this->codCedente . $this->codCedenteDV, 15, '0', STR_PAD_LEFT, 'convenio');
		$this->addField("", 5, ' ', STR_PAD_LEFT);//Uso exclusivo FEBRABAN
		$this->addField(strtoupper($beneficiario), 30, ' ', STR_PAD_RIGHT, 'nomeEmpresa');
		...
		$this->addField("", 41, ' ', STR_PAD_LEFT);//Uso exclusivo FEBRABAN
		$this->addField("\r\n", 2, '', STR_PAD_LEFT);
	...
	public function addTitulo(CNABSantanderTituloREM240 $oTitulo, $calcNossoNumero = true){
		...
		$this->addField('30', 2, '0', STR_PAD_LEFT, 'prazoBaixa');
		...
		$this->addField("033", 3, ' ', STR_PAD_LEFT, 'banco');
		$this->addField("1", 4, '0', STR_PAD_LEFT, 'lote');
		$this->addField("3", 1, '0', STR_PAD_LEFT, 'registro');
		$this->addField($this->sequencial++, 5, "0", STR_PAD_LEFT, 'n_registro');
		...
		$this->addField('', 61);//Uso exclusivo FEBRABAN
		$this->addField("\r\n", 2);
