...
class CNABEfiTituloREM240 extends CNABEfiTitulo{
	 ...
	 * @var number
	 */
	private $tpJuros = '3';//1 = Valor monetário, 2 = Percentual, 3 = Isento
	...
	/**
	 * @return the $tpDesconto
	 */
	public function getTpDesconto() {
		return $this->tpDesconto;
	}

	/**
	 * @return the $dtDesconto
	 */
	public function getDtDesconto() {
		return CNABUtil::retDate($this->dtDesconto, 'dmY');
	}
	 ...
	 */
	public function setTpDesconto($tpDesconto) {
		$this->tpDesconto = $tpDesconto;
	}

	/**
	 * @param string $dtDesconto
	 */
	public function setDtDesconto($dtDesconto) {
